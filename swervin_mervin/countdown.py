...
class CountDown():
    ...
    def __init__(self, level_number, level_name):
        ...
        self.remaining    = 3
        self.finished     = False
        self.text_font    = pygame.font.Font(s.FONTS["retro_computer"], 42)
    ...
    def progress(self, window):
        ...
        beep       = pygame.mixer.Sound(os.path.join("lib", "music", "%d.wav" % freq))

        window.fill(s.COLOURS["black"])
        window.blit(level_text, u.middle(level_text, y=50))
